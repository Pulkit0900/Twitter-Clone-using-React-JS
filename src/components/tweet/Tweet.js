  ...
  return (
    <div id="tweet-box">
      <div id="profile-tweet">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhCVLd_9MFHeH_I2Baz5Fq0f7onN7kDzBExA&usqp=CAU"
          alt="profile"
          id="image-profile"
        />
      </div>
      ...
      <div id="box-tweet">
        <div id="name-id">
          <span id="flex-tweet">
            <p id="tweet-name">Pulkit Kumar</p>
            <p id="tweet-id">@pulkitKumar </p>
